...
const translations = {
  es: {
    ...
    'hero.subtitle':
      'Ingeniero en Sistemas Inteligentes, especializado en el Desarrollo Web.',
    'hero.cv': 'Mi CV',
    ...
    'about.description':
      'Apasionado por la tecnología y el desarrollo web, me especializo en convertir ideas en soluciones digitales elegantes y funcionales.',
    'about.frontend': 'Desarrollo Frontend',
    'about.frontendDesc':
      'React, TypeScript y frameworks modernos para crear interfaces interactivas y responsivas.',
    'about.backend': 'Desarrollo Backend',
    'about.backendDesc':
      'Conocimientos en Node.js, .NET/C#, PHP (Laravel), Especializado en la construcción de APIs y sistemas backend eficientes.',
    'about.ai': 'Aplicación de IA',
    'about.aiDesc':
      'Apasionado por la aplicación de IA en el ciclo de desarrollo, utilizando herramientas como ChatGPT, GitHub Copilot y Lovable.',
    'about.music': 'DJ / Producción Músical',
    'about.musicDesc':
      'Sueño con convertirme en un DJ/Productor Músical, más allá de mi vida profesional, la música es mi pasión.',
    'about.experienceTitle': 'Mi experiencia',
    'about.experienceDesc':
      'Ingeniero en Sistemas Inteligentes con experiencia en aplicaciones web y de escritorio, tanto en frontend como en backend. Especializado en tecnologías como .NET, Angular, PHP, React y Node.js, con enfoque en soluciones escalables y optimización del rendimiento. Hábil para resolver problemas complejos y colaborar eficazmente en equipo para lograr resultados eficientes y orientados al usuario.',
    ...
    'experience.description':
      'Desarrollo e implementación de aplicaciones web y de escritorio a medida, optimizando procesos internos y ofreciendo soluciones tecnológicas eficientes para empresas privadas.',
    ...
    'project.bentho.challenge1':
      'Optimización en la consulta de lista de productos +100,000',
  ...
  en: {
    ...
    'hero.name': 'Eduardo Cordova',
    'hero.subtitle':
      'Intelligent Systems Engineer, specialized in Web Development.',
    'hero.cv': 'My Resume',
    ...
    'about.description':
      'Passionate about technology and web development, I specialize in turning ideas into elegant and functional digital solutions.',
    'about.frontend': 'Frontend Development',
    'about.frontendDesc':
      'React, TypeScript and modern frameworks to create interactive and responsive interfaces.',
    'about.backend': 'Backend Development',
    'about.backendDesc':
      'Knowledge in Node.js, .NET/C#, PHP (Laravel), Specialized in building efficient APIs and backend systems.',
    'about.ai': 'AI Application',
    'about.aiDesc':
      'Passionate about applying AI in the development cycle, using tools like ChatGPT, GitHub Copilot and Lovable.',
    'about.music': 'DJ / Music Production',
    'about.musicDesc':
      'I dream of becoming a DJ/Music Producer, beyond my professional life, music is my passion.',
    'about.experienceTitle': 'My experience',
    'about.experienceDesc':
      'Intelligent Systems Engineer with experience in web and desktop applications, both frontend and backend. Specialized in technologies such as .NET, Angular, PHP, React and Node.js, with a focus on scalable solutions and performance optimization. Skilled at solving complex problems and collaborating effectively in teams to achieve efficient and user-oriented results.',
    ...
    'education.period': '2018 - 2023',
    'education.description':
      'Comprehensive training in Computer Science and Artificial Intelligence',
    ...
    'experience.period': '2022 - 2024',
    'experience.description':
      'Development and implementation of custom web and desktop applications, optimizing internal processes and offering efficient technological solutions for private companies.',
    ...
    'project.hospital.feature6':
      'Administrative and medical history traceability',
    'project.hospital.challenge1': 'Relational database structuring.',

    // Project Bentho
    'project.bentho.title': 'BenthoCotizador',
    'project.bentho.description':
      'Web application for automatic quote generation for Bentho Automation.',
    'project.bentho.longDescription':
      'I developed an internal web application for automatic generation of specialized quotes for clients, optimizing the commercial flow and customer service. The solution made it possible to streamline the quote preparation process, significantly reduce response times, and improve the end-user experience.',
